...
import banana_user.view.MusicSearchView;
...
public class MusicController {
	...
	//음원목록출력
	public ArrayList<Music> requestSelectAllMusic() {
	...
	public void requestCallMusicSelectOneView(ArrayList<Music> searchMusicList) {
		...
		selectOne.musicSelectOneView(searchMusicList);
	...
	public void responseSearchMusic(String title) {
		...
		ArrayList<Music> searchMusicList = musicDao.searchMusic(title);
		
		MusicSearchView musicSearchView = new MusicSearchView();
		musicSearchView.printSearchMusicList(searchMusicList);
